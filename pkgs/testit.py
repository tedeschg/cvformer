...
from model import DihedralTransformerAE, WarmupCosineScheduler
from train import (
...
from utils import DihedralDataset, angles_to_sincos, compute_aligned_phi_psi
...
if __name__ == "__main__":
    ...
    parser.add_argument("--contrastive_weight", type=float, default=0.0) #0.1
    parser.add_argument("--contrastive_temp", type=float, default=0.0) #0.1
    parser.add_argument("--contrastive_noise", type=float, default=0.00) #0.05
