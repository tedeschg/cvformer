...
# run the simulation
echo "$gmx grompp -f /storage/brno2/home/tedeschg/prj/cvformer/prepare/md_files/md.mdp -c /storage/brno2/home/tedeschg/prj/cvformer/05.mtd_test-05_plain_cvformer/mtd01.gro -t /storage/brno2/home/tedeschg/prj/cvformer/05.mtd_test-05_plain_cvformer/mtd01.cpt -p /storage/brno2/home/tedeschg/prj/cvformer/prepare/topol.top -o mtd02" >> "$RUN_FILE"
echo "$gmx mdrun -deffnm mtd02 -plumed plumed.dat" >> "$RUN_FILE"
